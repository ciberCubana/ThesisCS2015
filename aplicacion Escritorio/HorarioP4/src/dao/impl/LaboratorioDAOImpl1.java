 ...
 * @author work
 */
public class LaboratorioDAOImpl1 implements LaboratorioDAO1 {
    ...
    public ArrayList<Laboratorio1> getAllLab(int ano, String carrera) {
        iniciaOperacion();
        Criteria criteria = session.createCriteria(Laboratorio1.class).add(Restrictions.eq("carrera", carrera)).add(Restrictions.eq("ano", new Integer(ano)));
    ...
    public ArrayList<Laboratorio1> getAll() {
        iniciaOperacion();
    ...
    public void deleteAll() {
        iniciaOperacion();
        ArrayList<Laboratorio1> l = getAll();
