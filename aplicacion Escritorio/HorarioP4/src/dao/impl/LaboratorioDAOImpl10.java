 ...
 * @author Family
 */
public class LaboratorioDAOImpl10 implements LaboratorioDAO10{
    ...
    public ArrayList<Laboratorio10> getAllLab(int ano, String carrera) {
        iniciaOperacion();
        Criteria criteria = session.createCriteria(Laboratorio10.class).add(Restrictions.eq("carrera", carrera)).add(Restrictions.eq("ano", new Integer(ano)));
    ...
    public ArrayList<Laboratorio10> getAll() {
        iniciaOperacion();
    ...
    public void deleteAll() {
        iniciaOperacion();
        ArrayList<Laboratorio10> l = getAll();
